...
%% REMOVE THIS LATER
\textit{Note to Dr. Clay: This section is not finished yet, I want to go into more detail about complex systems and the dynamic plane, but I don't understand it enough to write about it yet}\\
...
This will save an output image of the mandelbrot set at the given "zoom" to your home directory ("\textit{~}" on Unix systems, or "\textit{My Documents}" on Windows).
